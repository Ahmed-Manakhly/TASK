...
import background from '../assets/BACK-G.jpg' ;
//----------------------------------
  ...
  return (
          <>
            ...
            <div style={{
              ...
              <h1 className='' style={{fontSize:"60px"}}>You Just Need To Login ,to be able to browse our awesome NEWS! </h1>
              <br />
              <br />
              <hr className='fs-1'  style={{height:"7px" , color: '#ffff'}}/>
              <br />
              <h1 className='' >you can create a writer / publisher account</h1>
            </div>
          </div>}
            <div className="container-fluid pb-4  padding">
